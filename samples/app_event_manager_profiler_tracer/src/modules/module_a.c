...
#define MODULE_A_WORK_SIMULATE_CALCULATION_US \
		(MODULE_A_BURST_EVENT_NUMBER * MODULE_A_BURST_INTERVAL_US)
#define MODULE_A_BURST_EVENT_NUMBER 2000
#define MODULE_A_BURST_INTERVAL_US 1000
